...
import { categories, taskers } from '../lib/taskDisplay';
...
import {
  ...
  LayoutGrid, Shield, Clock, CheckCircle2, Star, ChevronRight, Award
} from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-6 pt-24 pb-20 sm:pt-32 sm:pb-28 relative">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-neutral-100 rounded-full text-xs font-medium text-neutral-600 mb-6">
              ...
              {t('Marketplace for tasks in Uzbekistan', "O'zbekistonda vazifalar bozori", 'Маркетплейс задач в Узбекистане')}
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {categories.length === 0 ? (
              <p className="col-span-full text-center text-sm text-neutral-500 py-8">
                {t('Categories will appear here once connected to the catalog.', 'Katalog ulangach kategoriyalar shu yerda paydo bo‘ladi.', 'Категории появятся после подключения каталога.')}
              </p>
            ) : (
      ...
      <section className="py-20 bg-neutral-50/50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {taskers.length === 0 ? (
              <p className="col-span-full text-center text-sm text-neutral-500 py-8">
                {t('No featured taskers yet.', 'Hozircha tavsiya etilgan ijrochilar yo‘q.', 'Пока нет рекомендуемых исполнителей.')}
              </p>
            ) : (
            ...
            <div className="relative">
              <div className="bg-neutral-50 rounded-3xl p-8 sm:p-10">
                <p className="text-sm text-neutral-500 leading-relaxed">
                  {t(
                    'Platform statistics will be shown here once data is available.',
                    'Ma’lumotlar paydo bo‘lgach, platforma statistikasi shu yerda ko‘rsatiladi.',
                    'Статистика платформы появится здесь, когда появятся данные.',
                  )}
                </p>
              </div>
            </div>
          ...
          <div className="bg-neutral-900 rounded-3xl p-10 sm:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-neutral-400 max-w-md mx-auto mb-8 text-lg">
                {t('Create an account and start posting or completing tasks on TaskUz.', 'TaskUz’da hisob oching va vazifalarni joylashtiring yoki bajaring.', 'Создайте аккаунт и публикуйте или выполняйте задачи в TaskUz.')}
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
